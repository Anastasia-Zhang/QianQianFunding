...
<header id="header">
    ...
    <ul class="top-menu">
        ...
        <li>
            ...
            <button class="btn btn-success" style="height: 40px;margin-right: 30px" onclick="location.href='raising'">RAISING FINANCE</button>
    ...
    <section id="content">
        ...
        <div id="content__grid" data-columns>
            ...
            <c:forEach var="projects" items="${project}">
                ...
                <div class="card" onclick="javascript:location.href='managePanel?projectId=${projects.projectId}'">
                    <div class="list-group">
