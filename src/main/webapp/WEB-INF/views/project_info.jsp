...
<header id="header">
    ...
    <ul class="top-menu">
        ...
        <div class="btn-demo" style="margin-top: 5px">
            <button class="btn btn-primary" style="height: 40px">Join</button>
            <button class="btn btn-success" style="height: 40px">Log in</button>
        </div>
    </ul>
...
<section id="main">
    ...
    <aside id="navigation">
        ...
        <div class="navigation__toggles">
            <button class="btn btn-info" style="width: 150px;margin-bottom: 5px">RAISING FINANCE</button>
            <br>
            <button class="btn btn-warning" style="width: 150px; margin-top: 5px" onclick="location.href='registerPage'" >INVEST</button>
        </div>

        <div class="navigation__menu c-overflow">
            <ul>
                <li class="navigation__active">
                    <a href="index_after_login.html"><i class="zmdi zmdi-home"></i>Opportunities</a>
                </li>
                <li><a href="typography.html"><i class="zmdi zmdi-format-underlined"></i> Explore</a></li>
                <li><a href="widgets.html"><i class="zmdi zmdi-widgets"></i> Risk warning</a></li>
    ...
    <section id="content">
        <header class="content__header">
            <h2>${project.projectHead}
                <small> By ${project.projectUsername}</small>
            </h2>
        </header>
